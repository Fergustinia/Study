...
import { updateTask, type UpdateTaskFormState } from "@/app/actions/tasks";
...
const initialState: UpdateTaskFormState = {};
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="space-y-2">
          ...
          <input
            ...
            type="number"
            min={0}
            defaultValue={initialValues.storyPoints}
      ...
      <div className="space-y-2">
        ...
        <select
          id="sprintId"
          name="sprintId"
          defaultValue={initialValues.sprintId ?? ""}
          className="flex h-10 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition focus:border-neutral-400"
        >
